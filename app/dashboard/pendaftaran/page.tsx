...
const STORAGE_KEY = "smk_tamako_teacher_registration_data";
const STORAGE_TAB_KEY = "smk_tamako_teacher_active_tab";
...
export default function RegistrationByTeacherPage() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-b from-white to-gray-50 max-sm:mt-16">
      <div className="w-full sm:border max-sm:p-5 md:p-10 lg:p-14 xl:p-20 flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col mb-6 max-sm:mb-0">
            ...
            <div className="w-full">
              <p className="text-primary text-2xl max-sm:text-xl mb-2">
                ...
                <span className="font-bold">Tamtama</span>
                🏫
              </p>
              <p className="text-gray-700 text-lg max-sm:text-base">
                📝 Sebagai guru, Anda dapat mendaftarkan murid baru ke SMK
                Tamtama.
              </p>
              <p className="text-gray-700 text-lg max-sm:text-base">
