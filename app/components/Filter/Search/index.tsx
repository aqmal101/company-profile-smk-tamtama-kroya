    ...
    <div className={className}>
      <div className={`relative w-full max-sm:w-full max-sm:pb-1`}>
        ...
        <input
          ...
          className="block max-sm:placeholder:text-xs w-full pl-10 pr-3 py-2 max-sm:py-1 border border-gray-300 rounded-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
        />
      </div>
    </div>
  );
